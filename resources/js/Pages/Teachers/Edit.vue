            ...
            <Container :width="'w-4/12'">
                ...
                <div class="flex mt-4">
                    <form class="w-full" @submit.prevent="submit">
                        ...
                        <div class="flex flex-col mt-3">
                            <label class="block text-gray-700 text-sm font-bold mb-2" for="last_name">CI</label>
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="ci" v-model="form.ci" />
