         ...
         <Layout>
            <div class="flex flex-col max-w-md shadow-md rounded px-8 pt-6 pb-8 my-8 mx-auto bg-white">
                <div class="flex flex-row text-2xl">
                    <h1>Agregar Alumno al Curso {{ course.id }}</h1>
                </div>

                <div class="flex mt-4">
                    <form class="" @submit.prevent="submit">
                        <div class="flex flex-col">
                            <label class="block text-gray-700 text-sm font-bold mb-2" for="first_name">Seleccione el alumno: </label>
                            ...
                            <div class="text-red-500 text-xs italic" v-if="errors.student_id">{{ errors.student_id }}</div>
                        </div>
